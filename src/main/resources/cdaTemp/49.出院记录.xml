...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${dischargeRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${dischargeRecord.archiaterDoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id root="2.16.156.10011.1.4" extension="${dischargeRecord.archiaterDoctorSign!'NA'}"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id root="2.16.156.10011.1.4" extension="${dischargeRecord.physicianDoctorSign!'NA'}"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id root="2.16.156.10011.1.4" extension="${dischargeRecord.inpDoctorSign!'NA'}"/>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <#if dischargeRecord.diagDesc??>
              <value xsi:type="ST">${dischargeRecord.diagDesc? replace('<','小于')? replace('>','大于')}</value>
              <#else>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <#if dischargeRecord.dishospitalSituation??>
              <value xsi:type="ST">${dischargeRecord.dishospitalSituation? replace('<','小于')? replace('>','大于')}</value>
              <#else>
          ...
          <#if dischargeRecord.outpDiagnosisCnName??>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${dischargeRecord.outhosTcmDisCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="<@dict_tag value="${dischargeRecord.outhosTcmDisCode!'NA'}" datasetCloumn="OUTHOS_TCM_DIS_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          </#if>
          <#if dischargeRecord.outpDiagnosisTcmName??>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <#if dischargeRecord.outhosSyndromesDisCode??>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
