...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${h24AdmissionDischargeRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${h24AdmissionDischargeRecord.outhosAdvicOpenerSig!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <legalAuthenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${h24AdmissionDischargeRecord.archiaterDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${h24AdmissionDischargeRecord.receiveDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${h24AdmissionDischargeRecord.inpDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${h24AdmissionDischargeRecord.physicianDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id root="2.16.156.10011.1.4" extension="${h24AdmissionDischargeRecord.outhosAdvicOpenerSig!'NA'}"/>
    ...
    <structuredBody>
      ...
      <component>
        <section>
          ...
          <#if h24AdmissionDischargeRecord.inhosDiagCmDisCode??>
          <!--入院诊断-中医条目-->
          <entry>
            <observation classCode="OBS" moodCode="EVN">
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="INT">
              ...
              <value code="${h24AdmissionDischargeRecord.therapeuticPrinciple!'NA'}" codeSystem="2.16.156.10011.2.3.3.15" codeSystemName="治则治法代码表(GB/T16751.3-1997)" displayName="<@dict_tag value="${h24AdmissionDischargeRecord.therapeuticPrinciple!'NA'}" datasetCloumn="THERAPEUTIC_PRINCIPLE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
        </section>
      </component>
      ...
      <component>
        <section>
          ...
          <#if h24AdmissionDischargeRecord.outhosTcmDisCode??>
          <!--出院诊断-中医条目-->
          <entry>
            <observation classCode="OBS" moodCode="EVN">
