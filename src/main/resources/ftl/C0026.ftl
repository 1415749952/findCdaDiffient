...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../sdschemas/CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole>
      ...
      <patient>
        ...
        <name><@privacy_tag value="${operationInformedConsent.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
        <!--性别-->
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${operationInformedConsent.treatingDoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <legalAuthenticator typeCode="LA">
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${operationInformedConsent.treatingDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${operationInformedConsent.operatorSign!'NA'}" root="2.16.156.10011.1.4"/>
      <assignedPerson>
        <!-- 手术者姓名 -->
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${operationInformedConsent.patientSign!'NA'}" root="2.16.156.10011.1.3"/>
      <assignedPerson>
        <!-- 患者姓名 -->
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${operationInformedConsent.legalAgentSign!'NA'}" root="2.16.156.10011.1.3"/>
      <!--代理人关系-->
