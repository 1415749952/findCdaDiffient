...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${caesareanSectionRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    <time value="${caesareanSectionRecord.operateEndTime!'NA'}"/>
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${caesareanSectionRecord.recordSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
        <name>${caesareanSectionRecord.recordSign!'NA'}</name>
      </assignedPerson>
    </assignedAuthor>
  </author>
  <!-- 保管机构 -->
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${caesareanSectionRecord.operationDoctorName!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${caesareanSectionRecord.doctorAnes!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${caesareanSectionRecord.nstrumentNurseName!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${caesareanSectionRecord.operationAssistantName!'NA'}" root="2.16.156.10011.1.4"/>
      <code displayName="助手"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${caesareanSectionRecord.pediatricianSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${caesareanSectionRecord.recordSign!'NA'}" root="2.16.156.10011.1.4"/>
                ...
                <asOrganizationPartOf classCode="PART">
                  ...
                  <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                    ...
                    <asOrganizationPartOf classCode="PART">
                      ...
                      <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                        <id extension="${caesareanSectionRecord.deptName!'NA'}" root="2.16.156.10011.1.26"/>
                        <name>${caesareanSectionRecord.deptName!'NA'}</name>
                        <asOrganizationPartOf classCode="PART">
                          <!--HDSD00.09.005 DE08.10.054.00 病区名称-->
                          <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                            <id extension="${caesareanSectionRecord.areaName!'NA'}" root="2.16.156.10011.1.27"/>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${caesareanSectionRecord.fetalPositionCode!'NA'}" codeSystem="2.16.156.10011.2.3.1.106" codeSystemName="胎方位代码表" xsi:type="CD" displayName="<@dict_tag value="${caesareanSectionRecord.fetalPositionCode!'NA'}" datasetCloumn="FETAL_POSITION_CODE">${dict.desc}</@dict_tag>"/>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value xsi:type="ST">${caesareanSectionRecord.abnumberrmalUmbilicalCord!'NA'}</value>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              <code code="DE04.30.056.00" codeSystem="2.16.156.10011.2.2.1" codeSystemName="卫生信息数据元目录" displayName="脐带扭转（周）"/>
              <value unit="周" value="${caesareanSectionRecord.umbilicalCordTwist!'NA'}" xsi:type="PQ"/>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value xsi:type="ST">${caesareanSectionRecord.uterineWallSuture!'NA'}</value>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value xsi:type="ST">${caesareanSectionRecord.abdominalExplorationUterus!'NA'}</value>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value value="${caesareanSectionRecord.exploreFibroidsFlag!'NA'}" xsi:type="BL"/>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value xsi:type="ST">${caesareanSectionRecord.operationMaternity!'NA'}</value>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${caesareanSectionRecord.deliveryOutcomeCode!'NA'}" codeSystem="2.16.156.10011.2.3.2.49" codeSystemName="分娩结局代码表" displayName="<@dict_tag value="${caesareanSectionRecord.deliveryOutcomeCode!'NA'}" datasetCloumn="DELIVERY_OUTCOME_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
