...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${anesthesiaRecords.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${anesthesiaRecords.anesthesiaDoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${anesthesiaRecords.anesthesiaDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
      ...
      <component>
        <section>
          ...
          <entry>
            <!-- 1..1 手术记录 -->
            <procedure classCode="PROC" moodCode="EVN">
              <code code="${anesthesiaRecords.operationCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.12" codeSystemName="手术(操作)代码表(ICD-9-CM)" displayName="<@dict_tag value="${anesthesiaRecords.operationCode!'NA'}" datasetCloumn="OPERATION_CODE">${dict.desc}</@dict_tag>"/>
              <!--操作日期/时间-->
              <effectiveTime>
                <!--手术开始日期时间-->
              ...
              <performer>
                <assignedEntity>
                  <id extension="${anesthesiaRecords.operationDoctorName!'NA'}" root="2.16.156.10011.1.4"/>
                  <assignedPerson>
