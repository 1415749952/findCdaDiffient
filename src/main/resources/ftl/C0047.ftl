...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${preOperationDiscussion.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${preOperationDiscussion.doctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${preOperationDiscussion.operativeSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${preOperationDiscussion.anaesthesiaDoctorName!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${preOperationDiscussion.doctorSign!'NA'}" root="2.16.156.10011.1.4"/>
      <code displayName="医师"/>
      <assignedPerson>
        <name>${preOperationDiscussion.doctorSign!'NA'}</name>
        <professionalTechnicalPosition>
  ...
  <participant typeCode="ORG">
    <associatedEntity classCode="ECON">
      <id extension="${preOperationDiscussion.compereName!'NA'}" root="2.16.156.10011.1.4"/>
      <associatedPerson>
        <!--主持人姓名-->
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <#if preOperationDiscussion.operativeIndication??>
              <value xsi:type="ST">${preOperationDiscussion.operativeIndication? replace('<','小于')? replace('>','大于')}</value>
              <#else>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <#if preOperationDiscussion.discussSuggestion??>
              <value xsi:type="ST">${preOperationDiscussion.discussSuggestion? replace('<','小于')? replace('>','大于')}</value>
              <#else>
