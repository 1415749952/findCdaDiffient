...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${generalCarerEcords.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
        ...
        <#if generalCarerEcords.ageYear??>
        <age unit="岁" value="${generalCarerEcords.ageYear!'NA'}"/>
        <#else>
        <age unit="月" value="${generalCarerEcords.patientMonth!'NA'}"/>
        </#if>
      </patient>
      <!--医疗机构信息-->
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${generalCarerEcords.nurseSign!'NA'}" root="2.16.156.10011.1.7"/>
      <code displayName="护士"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${generalCarerEcords.nurseSign!'NA'}" root="2.16.156.10011.1.4"/>
      <code displayName="护士"/>
      <assignedPerson>
        <name>${generalCarerEcords.nurseSign!'NA'}</name>
      </assignedPerson>
                ...
                <asOrganizationPartOf classCode="PART">
                  ...
                  <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                    ...
                    <asOrganizationPartOf classCode="PART">
                      <!--科室名称：DE08.10.026.00-->
                      <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                        <id extension="${generalCarerEcords.deptName!'NA'}" root="2.16.156.10011.1.26"/>
                        <name>${generalCarerEcords.deptName!'NA'}</name>
                        <asOrganizationPartOf classCode="PART">
                          <!--病区名称：DE08.10.054.00-->
                          <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                            <id extension="${generalCarerEcords.areaName!'NA'}" root="2.16.156.10011.1.27"/>
