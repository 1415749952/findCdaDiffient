...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${hours24AdmissionDeathRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${hours24AdmissionDeathRecord.receiveDoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <legalAuthenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${hours24AdmissionDeathRecord.archiaterDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${hours24AdmissionDeathRecord.receiveDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${hours24AdmissionDeathRecord.inpDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${hours24AdmissionDeathRecord.physicianDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
    ...
    <structuredBody>
      ...
      <component>
        <section>
          ...
          <#if hours24AdmissionDeathRecord.inhosDiagCmDisCode??>
          <!--入院诊断-中医条目-->
          <entry>
            <observation classCode="OBS" moodCode="EVN">
      ...
      <component>
        <section>
          ...
          <#if hours24AdmissionDeathRecord.deathDiagCmDisCode??>
          <!--死亡诊断-中医条目-->
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <entryRelationship typeCode="COMP">
                <observation classCode="OBS" moodCode="EVN">
                  ...
                  <value code="${hours24AdmissionDeathRecord.deathDiagCmSyndromeCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="<@dict_tag value="${hours24AdmissionDeathRecord.deathDiagCmSyndromeCode!'NA'}" datasetCloumn="DEATH_DIAG_CM_SYNDROME_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
                </observation>
              </entryRelationship>
            </observation>
          </entry>
