...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <telecom value="<@privacy_tag value="${surveyRecord.patientPhone!'NA'}" privacyId="5">${privacy}</@privacy_tag>"/>
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${surveyRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${surveyRecord.reportDoctor!'NA'}" root="2.16.156.10011.1.7"/>
      <!--医师姓名-->
      <assignedPerson>
  ...
  <legalAuthenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${surveyRecord.reportaudit!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${surveyRecord.inspectionEngineer!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${surveyRecord.inspectionDoctor!'NA'}" root="2.16.156.10011.1.4"/>
              ...
              <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                ...
                <asOrganizationPartOf classCode="PART">
                  <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                    ...
                    <asOrganizationPartOf classCode="PART">
                      <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                        <id extension="${surveyRecord.deptName!'NA'}" root="2.16.156.10011.1.26"/>
                        <name>${surveyRecord.deptName!'NA'}</name>
                        <!--DE08.10.054.00病区名称-->
                        <asOrganizationPartOf classCode="PART">
                          <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                            <id extension="${surveyRecord.areaName!'NA'}" root="2.16.156.10011.1.27"/>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <#if surveyRecord.inspectionReportResult??>
              <value xsi:type="ST">${surveyRecord.inspectionReportResult? replace('<','小于')? replace('>','大于')}</value>
              <#else>
