...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${emergencyMedicalRecords.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${emergencyMedicalRecords.adviceOpendoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <!-- 就诊医师 -->
      <assignedPerson>
  ...
  <legalAuthenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${emergencyMedicalRecords.adviceOpendoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <component>
    <structuredBody>
      <#if (emergencyMedicalRecords.allergyHostoryFlag??) && (emergencyMedicalRecords.allergyHistory??)>
      <!-- 过敏史章节 -->
      <component>
        <section>
      ...
      <#if (emergencyMedicalRecords.dialecticalAccrod??) && (emergencyMedicalRecords.therapeuticPrinciple??)>
      <!-- 治疗计划章节 -->
      <component>
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${emergencyMedicalRecords.therapeuticPrinciple!'NA'}" codeSystem="2.16.156.10011.2.3.3.15" codeSystemName="治则治法代码表(GB/T16751.3-1997)" xsi:type="CD" displayName="<@dict_tag value="${emergencyMedicalRecords.therapeuticPrinciple!'NA'}" datasetCloumn="THERAPEUTIC_PRINCIPLE">${dict.desc}</@dict_tag>"/>
            </observation>
          </entry>
        </section>
      </component>
              ...
              <component>
                <observation classCode="OBS" moodCode="EVN">
                  ...
                  <performer>
                    ...
                    <assignedEntity>
                      <id extension="${emergencyMedicalRecords.execPersonSign!'NA'}" root="2.16.156.10011.1.4"/>
                      <code/>
                  ...
                  <participant typeCode="ATND">
                    ...
                    <participantRole classCode="ASSIGNED">
                      <id extension="${emergencyMedicalRecords.checkPersonSign!'NA'}" root="2.16.156.10011.1.4"/>
                      <!--角色-->
                  ...
                  <participant typeCode="ATND">
                    ...
                    <participantRole classCode="ASSIGNED">
                      <id extension="${emergencyMedicalRecords.cancelPersonSign!'NA'}" root="2.16.156.10011.1.4"/>
                      <!--角色-->
      ...
      <#if emergencyMedicalRecords.opertorCode??>
      <!-- 手术操作章节 -->
      <component>
        <section>
      ...
      <#if emergencyMedicalRecords.emergencyRescueRecord??>
      <!-- 抢救记录章节 -->
      <component>
        <section>
          ...
          <entry typeCode="COMP">
            <observation classCode="OBS" moodCode="EVN">
              ...
              <effectiveTime>
                <#if emergencyMedicalRecords.rescueBeginDatetime??>
                <low value="${emergencyMedicalRecords.rescueBeginDatetime!'NA'}"/>
                </#if>
                <#if emergencyMedicalRecords.rescueEndDatetime??>
