...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${expectantRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${expectantRecord.recordSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${expectantRecord.laborInspectionSig!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${expectantRecord.recordSign!'NA'}" root="2.16.156.10011.1.4"/>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value unit="cm" value="${expectantRecord.exitDiameter!'NA'}" xsi:type="PQ"/>
            </observation>
          </entry>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
