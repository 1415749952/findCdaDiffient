...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${preciousConsumUsageRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${preciousConsumUsageRecord.nurseSign!'NA'}" root="2.16.156.10011.1.7"/>
      <code displayName="护士"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${preciousConsumUsageRecord.nurseSign!'NA'}" root="2.16.156.10011.1.4"/>
      <code displayName="护士"/>
      <assignedPerson>
        <!--护士姓名-->
        <name>${preciousConsumUsageRecord.nurseSign!'NA'}</name>
                ...
                <asOrganizationPartOf classCode="PART">
                  ...
                  <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                    ...
                    <asOrganizationPartOf classCode="PART">
                      <!--科室名称：DE08.10.026.00-->
                      <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                        <id extension="${preciousConsumUsageRecord.deptName!'NA'}" root="2.16.156.10011.1.26"/>
                        <name>${preciousConsumUsageRecord.deptName!'NA'}</name>
                        <asOrganizationPartOf classCode="PART">
                          <!--病区名称：DE08.10.054.00-->
                          <wholeOrganization classCode="ORG" determinerCode="INSTANCE">
                            <id extension="${preciousConsumUsageRecord.areaName!'NA'}" root="2.16.156.10011.1.27"/>
