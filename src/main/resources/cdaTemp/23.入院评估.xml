...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <!-- 移动电话 -->
      <telecom use="MP" value="<@privacy_tag value="${admissionAssessment.patientPhone!'NA'}" privacyId="5">${privacy}</@privacy_tag>"/>
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${admissionAssessment.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${admissionAssessment.nursingSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
        <!-- 访视医生姓名 -->
  ...
  <legalAuthenticator typeCode="LA">
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${admissionAssessment.nursingSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <assignedEntity classCode="ASSIGNED">
      <id extension="${admissionAssessment.receptionNursingSign!'NA'}" root="2.16.156.10011.1.4"/>
    ...
    <structuredBody>
      ...
      <component>
        <section>
          ...
          <text/>
          <#if admissionAssessment.apgarGrade??>
          <entry>
            <observation classCode="OBS" moodCode="EVN">
