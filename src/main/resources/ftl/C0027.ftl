...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../sdschemas/CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole>
      ...
      <patient>
        ...
        <name><@privacy_tag value="${cseInformedConsent.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
        <!--性别-->
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${cseInformedConsent.anesthesiaDoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <legalAuthenticator typeCode="LA">
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${cseInformedConsent.anesthesiaDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
      <assignedPerson>
        <name>${cseInformedConsent.anesthesiaDoctorSign!'NA'}</name>
      </assignedPerson>
    </assignedEntity>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${cseInformedConsent.patientSign!'NA'}" root="2.16.156.10011.1.3"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${cseInformedConsent.legalAgentSign!'NA'}" root="2.16.156.10011.1.3"/>
      <!--代理人关系-->
