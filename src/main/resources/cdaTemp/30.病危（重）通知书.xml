...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../sdschemas/CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole>
      ...
      <patient>
        ...
        <name><@privacy_tag value="${criticallyIllNotice.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
        <!--性别-->
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${criticallyIllNotice.doctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <legalAuthenticator typeCode="LA">
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${criticallyIllNotice.doctorSign!'NA'}" root="2.16.156.10011.1.4"/>
      <assignedPerson>
        <name>${criticallyIllNotice.doctorSign!'NA'}</name>
      </assignedPerson>
    </assignedEntity>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${criticallyIllNotice.patientName!'NA'}" root="2.16.156.10011.1.3"/>
      <code displayName="患者"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${criticallyIllNotice.legalAgentSign!'NA'}" root="2.16.156.10011.1.3"/>
      <!--代理人关系-->
