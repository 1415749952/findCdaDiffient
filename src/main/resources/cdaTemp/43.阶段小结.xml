...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${phaseSummary.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${phaseSummary.doctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${phaseSummary.doctorSign!'NA'}" root="2.16.156.10011.1.4"/>
    ...
    <structuredBody>
      ...
      <component>
        <section>
          ...
          <#if phaseSummary.inhosDiagCmDisCode??>
          <!--入院诊断-中医病名代码-->
          <entry>
            <observation classCode="OBS" moodCode="EVN">
          ...
          <#if phaseSummary.inhosDiagCmSyndromeCode??>
          <!--入院诊断-中医症候代码-->
          <entry>
            <observation classCode="OBS" moodCode="EVN">
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <#if phaseSummary.diagDesc??>
              <value xsi:type="ST">${phaseSummary.diagDesc? replace('<','小于')? replace('>','大于')}</value>
              <#else>
