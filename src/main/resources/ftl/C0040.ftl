...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ../sdschemas/CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${intractableDiscussRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${intractableDiscussRecord.doctorSign!'NA'}" root="2.16.156.10011.1.7"/>
  ...
  <legalAuthenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${intractableDiscussRecord.archiaterDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${intractableDiscussRecord.doctorSign!'NA'}" root="2.16.156.10011.1.4"/>
      <code displayName="医师"/>
      <assignedPerson classCode="PSN" determinerCode="INSTANCE">
        <name>${intractableDiscussRecord.doctorSign!'NA'}</name>
      </assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${intractableDiscussRecord.physicianDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${intractableDiscussRecord.compereName!'NA'}" root="2.16.156.10011.1.4"/>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN ">
              ...
              <#if intractableDiscussRecord.discussSuggestion??>
              <value xsi:type="ST">${intractableDiscussRecord.discussSuggestion? replace('<','小于')? replace('>','大于')}</value>
              <#else>
