...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${generalOperationRecords.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${generalOperationRecords.operationDoctorSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${generalOperationRecords.operationDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
          ...
          <entry>
            <procedure classCode="PROC" moodCode="EVN">
              ...
              <performer typeCode="PRF">
                <assignedEntity>
                  <id extension="${generalOperationRecords.operationDoctorName!'NA'}" root="2.16.156.10011.1.4"/>
                  <assignedPerson>
              ...
              <participant typeCode="ATND">
                <participantRole classCode="ASSIGNED">
                  <id extension="${generalOperationRecords.firstAssistantName!'NA'}" root="2.16.156.10011.1.4"/>
                  <code displayName="Ⅰ助"/>
              ...
              <participant typeCode="ATND">
                <participantRole classCode="ASSIGNED">
                  <id extension="${generalOperationRecords.secondeAssistantName!'NA'}" root="2.16.156.10011.1.4"/>
                  <code displayName="Ⅱ助"/>
                  <playingEntity classCode="PSN" determinerCode="INSTANCE">
              ...
              <participant typeCode="ATND">
                <participantRole classCode="ASSIGNED">
                  <id extension="${generalOperationRecords.instruNurseName!'NA'}" root="2.16.156.10011.1.4"/>
              ...
              <participant typeCode="ATND">
                <participantRole classCode="ASSIGNED">
                  <id extension="${generalOperationRecords.tourNurseName!'NA'}" root="2.16.156.10011.1.4"/>
            ...
            <observation classCode="OBS" moodCode="EVN">
              ...
              <entryRelationship typeCode="COMP">
                <observation classCode="OBS" moodCode="EVN">
                  ...
                  <value code="${generalOperationRecords.opertationTargetCode!'NA'}" codeSystem="2.16.156.10011.2.3.1.262" codeSystemName="手术体位代码表" displayName="<@dict_tag value="${generalOperationRecords.opertationTargetCode!'NA'}" datasetCloumn="OPERTATION_TARGET_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
                </observation>
              </entryRelationship>
              <!--皮肤消毒描述-->
              <entryRelationship typeCode="COMP">
