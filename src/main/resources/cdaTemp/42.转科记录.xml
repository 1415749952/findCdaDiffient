...
<ClinicalDocument xmlns="urn:hl7-org:v3" xmlns:mif="urn:hl7-org:v3/mif" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="urn:hl7-org:v3 ..\sdschemas\CDA.xsd">
  ...
  <recordTarget contextControlCode="OP" typeCode="RCT">
    <patientRole classCode="PAT">
      ...
      <patient classCode="PSN" determinerCode="INSTANCE">
        ...
        <name><@privacy_tag value="${transferenceRecord.patientName!'NA'}" privacyId="2">${privacy}</@privacy_tag></name>
  ...
  <author contextControlCode="OP" typeCode="AUT">
    ...
    <assignedAuthor classCode="ASSIGNED">
      <id extension="${transferenceRecord.overintoDeptSign!'NA'}" root="2.16.156.10011.1.7"/>
      <assignedPerson>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${transferenceRecord.turnoutDoctorSign!'NA'}" root="2.16.156.10011.1.4"/>
  ...
  <authenticator>
    ...
    <signatureCode/>
    <assignedEntity>
      <id extension="${transferenceRecord.overintoDeptSign!'NA'}" root="2.16.156.10011.1.4"/>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${transferenceRecord.inhosDiagWmDiagCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.11" codeSystemName="ICD-10" displayName="<@dict_tag value="${transferenceRecord.inhosDiagWmDiagCode!'NA'}" datasetCloumn="INHOS_DIAG_WM_DIAG_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${transferenceRecord.inhosDiagCmDisCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="<@dict_tag value="${transferenceRecord.inhosDiagCmDisCode!'NA'}" datasetCloumn="INHOS_DIAG_CM_DIS_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          </#if>
          <#if transferenceRecord.inhosDiagCmSyndromeCode??>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${transferenceRecord.inhosDiagCmSyndromeCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="<@dict_tag value="${transferenceRecord.inhosDiagCmSyndromeCode!'NA'}" datasetCloumn="INHOS_DIAG_CM_SYNDROME_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          </#if>
        </section>
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${transferenceRecord.currentlyWmDiagcode!'NA'}" codeSystem="2.16.156.10011.2.3.3.11" codeSystemName="ICD-10" displayName="<@dict_tag value="${transferenceRecord.currentlyWmDiagcode!'NA'}" datasetCloumn="CURRENTLY_WM_DIAGCODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${transferenceRecord.transferTcmDiseasesCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="<@dict_tag value="${transferenceRecord.transferTcmDiseasesCode!'NA'}" datasetCloumn="TRANSFER_TCM_DISEASES_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          </#if>
          ...
          <entry>
            <observation classCode="OBS" moodCode="EVN">
              ...
              <value code="${transferenceRecord.transferTcmSyndromesCode!'NA'}" codeSystem="2.16.156.10011.2.3.3.14" codeSystemName="中医病证分类与代码表( GB/T 15657)" displayName="<@dict_tag value="${transferenceRecord.transferTcmSyndromesCode!'NA'}" datasetCloumn="TRANSFER_TCM_SYNDROMES_CODE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          </#if>
          <!--中医“四诊”观察结果-->
        ...
        <section>
          ...
          <entry>
            <observation classCode="OBS " moodCode="EVN">
              ...
              <value code="${transferenceRecord.transferRcdType!'NA'}" codeSystem="2.16.156.10011.2.3.2.56" codeSystemName="转科记录类型代码表" displayName="<@dict_tag value="${transferenceRecord.transferRcdType!'NA'}" datasetCloumn="TRANSFER_RCD_TYPE">${dict.desc}</@dict_tag>" xsi:type="CD"/>
            </observation>
          </entry>
          <!--转出科室-->
          <entry>
